        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubMerchantKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CommissionRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ISAproved = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VeterinarianDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VeterinarianDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VeterinarianDetails_Clinic_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VeterinarianDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppointmentTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    TransactionID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VeterinarianNote = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_VeterinarianDetails_VeterinarianDetailId",
                        column: x => x.VeterinarianDetailId,
                        principalTable: "VeterinarianDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentItems_Treatments_TreatmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a1b2c3d4-e5f6-7a8b-9c0d-1234567890ab", "stamp-admin-12345", "Admin", "ADMIN" },
                    { "b2c3d4e5-f6a7-8b9c-0d1e-234567890abc", "stamp-vet-12345", "Veterinarian", "VETERINARIAN" },
                    { "c3d4e5f6-a7b8-9c0d-1e2f-34567890abcd", "stamp-user-12345", "StandardUser", "STANDARDUSER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentItems_TreatmentId",
                table: "AppointmentItems",
                column: "TreatmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_VeterinarianDetailId",
                table: "Appointments",
                column: "VeterinarianDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VeterinarianDetails_ClinicId",
                table: "VeterinarianDetails",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_VeterinarianDetails_UserId",
                table: "VeterinarianDetails",
                column: "UserId",
                unique: true);
